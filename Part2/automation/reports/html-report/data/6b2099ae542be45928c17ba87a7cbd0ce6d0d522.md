...
- Name: Mandatory and Optional Field Validation - Section 4 >> 4.2.1b - Test form submission with only mandatory fields and verify no errors for optional fields
- Location: C:\Users\Ndzelen Glen Afoni\Documents\QA Engineer Challenge\Part2\automation\tests\validation-tests\mandatory-optional-fields.spec.js:127:3
...
Call log:
  - navigating to "https://qa-assessment.pages.dev/", waiting until "load"
    ...
    at C:\Users\Ndzelen Glen Afoni\Documents\QA Engineer Challenge\Part2\automation\tests\validation-tests\mandatory-optional-fields.spec.js:11:27
```
...
- paragraph: We can’t connect to the server at qa-assessment.pages.dev.
- paragraph
