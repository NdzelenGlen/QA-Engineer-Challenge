...
Received: false
    at C:\Users\Ndzelen Glen Afoni\Documents\QA Engineer Challenge\Part2\automation\tests\validation-tests\form_validation.spec.js:90:22
```
...
- textbox "First Name (mandatory):": John123
...
```ts
   ...
   4 | import { validUserData, invalidFirstNames, invalidLastNames, invalidEmails, invalidLinkedInUrls, invalidGitHubUrls } from '../../test-data/testData.js';
   5 |
   6 | test.describe('Form Validation Testing - Section 2 & 3', () => {
